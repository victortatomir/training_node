...
exports.updateOrder = exports.removeOrder = exports.addOrder = exports.getOrderById = exports.getOrder = void 0;
...
var getOrderById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_1.default.find({ id: Number(req.params.id) })];
            case 1:
                order = _a.sent();
                res.send(order);
                return [3 /*break*/, 3];
...
var removeOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_1.default.deleteMany({ id: Number(req.params.id) }, { new: true })];
            case 1:
                order = _a.sent();
...
var updateOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order_1.default.findOneAndUpdate({ id: Number(req.params.id) }, req.body, { new: true })];
            case 1:
                order = _a.sent();
                res.send(order);
                return [3 /*break*/, 3];
